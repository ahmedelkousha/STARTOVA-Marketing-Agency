    ...
    <>
      <section className="bg-black text-white py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <AnimatedSection>
            <h1 className="font-display text-5xl md:text-7xl font-bold mb-6">Let's Build Your Growth System.</h1>
            <p className="text-xl text-gray-400 max-w-2xl mx-auto font-light">
              Stop guessing. Start structuring. Drop us a line and let's discuss your objectives.
            </p>
          </AnimatedSection>
        </div>
      </section>
                ...
                <div className="bg-white p-8 md:p-12 rounded-3xl shadow-xl border border-gray-100">
                  ...
                  {isSuccess ? (
                    <div className="flex flex-col items-center justify-center py-12 text-center h-full">
                      ...
                      <p className="text-gray-600">Thank you for reaching out. A growth specialist will contact you within 24 hours.</p>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                      ...
                      <div className="grid md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-2">
                          <label htmlFor="service" className="text-sm font-semibold">Primary Interest *</label>
                          <select 
                            {...register("service")}
                            id="service"
                          ...
                          >
                            ...
                            <option value="general">General Inquiry / Strategy Call</option>
                            {SERVICES.map(s => (
              ...
              <AnimatedSection delay={0.2}>
                <div className="space-y-10">
                  <div>
                    ...
                    <p className="text-gray-600 mb-8">Prefer to reach out directly? Use the information below to get in touch with our team.</p>
                  </div>
                  ...
                  <div className="space-y-8">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">100 Innovation Drive, Suite 400<br/>New York, NY 10001</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">hello@startova.agency<br/>strategy@startova.agency</p>
                      </div>
                    </div>
